...
void init(void)
{
	...
	glLoadIdentity();
	AUX_RGBImageRec* image = auxDIBImageLoadA("C:\\Users\\Ильдар\\Desktop\\Учеба\\ComputerGraphic\\Labs\\Лаба 5\\texture_1.bmp"); //для загрузки в оперативную память изображения
	AUX_RGBImageRec* image2 = auxDIBImageLoadA("C:\\Users\\Ильдар\\Desktop\\Учеба\\ComputerGraphic\\Labs\\Лаба 5\\texture_2.bmp");
	AUX_RGBImageRec* image3 = auxDIBImageLoadA("C:\\Users\\Ильдар\\Desktop\\Учеба\\ComputerGraphic\\Labs\\Лаба 5\\texture_3.bmp");
